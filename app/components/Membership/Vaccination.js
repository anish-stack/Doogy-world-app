...
const Vaccination = () => {
    ...
    return (
        <ScrollView className="flex-1 p-4 space-y-4">
            <AccordionItem
                title="Cat Vaccination Package"
                price="1899/year"
                savings="Save more than Rs. 3000"
                benefits={[
                    "Free 2 vaccinations worth Rs. 1800",
                    "Unlimited Doctor Consultation @ Rs. 299",
                    "Any Grooming Service @ 20% Off",
                    "All Vaccinations @ 10% Off",
                    "Elective Surgery @ 20% Off",
